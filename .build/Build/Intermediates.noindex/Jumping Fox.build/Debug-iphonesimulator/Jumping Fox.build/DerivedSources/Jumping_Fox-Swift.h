...
#ifndef JUMPING_FOX_SWIFT_H
#define JUMPING_FOX_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Jumping_Fox",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11Jumping_Fox12GamePlatform")
@interface GamePlatform : SKNode
...
@class UITouch;
@class UIEvent;
SWIFT_CLASS("_TtC11Jumping_Fox9GameScene")
...
SWIFT_CLASS("_TtC11Jumping_Fox19NotificationManager")
...
@interface NotificationManager (SWIFT_EXTENSION(Jumping_Fox)) <UNUserNotificationCenterDelegate>
...
SWIFT_CLASS("_TtC11Jumping_Fox27PromotedPurchaseCoordinator")
@interface PromotedPurchaseCoordinator : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

@interface PromotedPurchaseCoordinator (SWIFT_EXTENSION(Jumping_Fox)) <SKPaymentQueueDelegate>
@end
